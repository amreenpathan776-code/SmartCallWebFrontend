...
const [selectedColumns, setSelectedColumns] = useState(ALL_COLUMNS);
  ...
  // ================= LOAD CLUSTERS =================
  useEffect(() => {
    axios.get("http://40.80.79.26:5001/api/clusters")
      .then(res => {
        setClusters([
  ...
  useEffect(() => {
    ...
    axios.get(`http://40.80.79.26:5001/api/branches/${filters.cluster}`)
      .then(res => {
  ...
  useEffect(() => {
    axios.post("http://40.80.79.26:5001/api/assignUsers", {
...
const handleSearch = async () => {
  ...
  try {
    const res = await axios.post(
      "http://40.80.79.26:5001/api/cash-collection-report/search",
      filters
    );
...
const handleExportPDF = async () => {
  ...
  const response = await axios.post(
    "http://40.80.79.26:5001/api/cash-collection-report/export-pdf",
    {
